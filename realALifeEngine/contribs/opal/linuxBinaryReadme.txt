...
lib - OPAL libraries (debug and release versions of the OPAL shared libraries built with single and double floating point precision)
...
linuxBinaryReadme.txt - you're reading it
...
Installation:
------------------------------------
Copy the OPAL headers and libraries into your include and library path, respectively.
