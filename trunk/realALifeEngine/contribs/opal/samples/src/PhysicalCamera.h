...
namespace opalSamples
{
	...
	public:
		...
		void setPosition(const opal::Point3r& pos)
		{
			...
			{
				mOgreCamera->getParentSceneNode()->setPosition(pos[0], 
					pos[1], pos[2]);
			}
		}
		...
		void moveRelative(const opal::Vec3r& dir)
		{
			...
			else
			{
				...
				mOgreCamera->getParentSceneNode()->translate(ogreVec, 
					Ogre::Node::TS_LOCAL);
			}
		}
		...
		void yawRelative(opal::real degrees)
		{
			...
			mOgreCamera->getParentSceneNode()->rotate(Ogre::Vector3(0, 1, 0), 
				Ogre::Radian(Ogre::Degree(degrees)), Ogre::Node::TS_WORLD);
		}
		...
		void pitchRelative(opal::real degrees)
		{
			...
			mOgreCamera->getParentSceneNode()->rotate(Ogre::Vector3(1, 0, 0), 
				Ogre::Radian(Ogre::Degree(degrees)), Ogre::Node::TS_LOCAL);
		}
	...
	private:
		...
		/// The desired position for grasped objects relative to the camera.
