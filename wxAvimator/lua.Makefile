...
APP_NAME = luaAvimator

OBJS = LuaMain.o MainApplication.o LuaScriptEditor.o LuaScriptEngine.o AnimationView.o Animation.o Camera.o SLPartsMale.o SLPartsFemale.o Math3D.o IKTree.o glm.o bvh.o 
...
avlua: LuaMain.o MainApplication.o AnimationView.o Animation.o Camera.o SLPartsMale.o SLPartsFemale.o Math3D.o IKTree.o glm.o bvh.o
	 $(CC) $(CFLAGS) -O3 -o $@ $(OBJS) $(LIBS)
